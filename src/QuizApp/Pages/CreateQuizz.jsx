    ...
    <div className='w-full p-8 max-h-screen overflow-scroll bg-gray-200'>
        <div className="bg-white w-full rounded-md">
            <header className='p-3 relative h-32 flex items-center justify-center'>
                <img src={`../../../sources/${state.categoria}.jpg`} className='absolute rounded-md w-full h-full  object-cover' alt="" />
                <div className='bg-black/30 absolute w-full z-10 h-full'></div>
                <h1 className='text-center text-5xl text-gray-100 font-semibold z-10'>{state.Cuestionario}</h1>
            ...
            <div className='bg-white w-full p-3  '>
                <div className="flex">
                    <div className="bg-gray-100 p-2 shadow-lg basis-1/4">
                        ...
                        <div className=" mt-4">
                            <Link to='/CreateQuiz/opcionMultiple' className="bg-orange-500  w-full py-2 px-3 rounded-full flex justify-center items-center text-white text-sm font-semibold">
